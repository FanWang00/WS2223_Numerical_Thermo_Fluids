...
class HODMD(DMDBase):
    ...
    def __init__(self, svd_rank=0, tlsq_rank=0, exact=False, opt=False, nx=None, ny=None, n_plot=10,  d=1):
        super(HODMD, self).__init__(svd_rank, tlsq_rank, exact, opt, nx, ny, n_plot)
        self.d = d
